...
import { TABS, ORDERS_PER_PAGE, STATUS_CONFIG } from "./orderConstants";
...
const OrdersClient = ({ initialOrders, initialTotal }) => {
    const [expandedId, setExpandedId] = useState(null);
    const { activeTab, orders, total, skip, loading, handleTabChange, handlePage } =
        useOrders(initialOrders, initialTotal);
