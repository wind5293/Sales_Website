        ...
        <div className="min-h-screen w-full flex items-center justify-center bg-[url('https://images.unsplash.com/photo-1593642632823-8f785ba67e45?q=80&w=1200')] bg-cover bg-center bg-no-repeat px-4 sm:px-6 py-10">
            <div className="w-full max-w-[450px] bg-white p-8 sm:p-10 border border-gray-100">
                ...
                <p className="text-sm text-gray-500 mb-6 text-center">
                    Đã có tài khoản?{' '}
                    <a href="#" onClick={(e) => { e.preventDefault(); router.push('/login'); }} className="font-semibold text-gray-900 hover:underline">
                        Đăng nhập ngay
                    </a>
                </p>

                {message && (
                    <div className="mb-4 p-3 text-sm bg-green-50 text-green-700 border border-green-200 text-center">{message}</div>
                )}
                {error && (
                    <div className="mb-4 p-3 text-sm bg-red-50 text-red-700 border border-red-200 text-center">{error}</div>
                )}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <label htmlFor="tel" className="block text-sm font-medium text-gray-700 mb-1">Số điện thoại</label>
                        <input
                            id="tel" type="tel" value={tel}
                    ...
                    <button type="submit" className="w-full py-2.5 bg-amber-400 hover:bg-amber-500 text-gray-900 font-semibold transition shadow-sm text-sm mt-2">
                        Tạo tài khoản
                    </button>
                </form>
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                    <button type="button" className="flex items-center justify-center gap-2 py-2 border border-gray-300 text-gray-700 font-medium hover:bg-gray-50 transition">
                        <GoogleIcon /> Google
                    </button>
                    <button type="button" className="flex items-center justify-center gap-2 py-2 border border-gray-300 text-gray-700 font-medium hover:bg-gray-50 transition">
