    ...
    return (
        <div className="bg-slate-50 min-h-screen">
            <div className="max-w-7xl mx-auto px-4 py-8">
                            ...
                            <div className="flex gap-3 overflow-x-auto pb-1">
                                {gallery.map((img, i) => (
                                    <button
                                        ...
                                        className={`h-16 w-16 rounded-md border-2 overflow-hidden flex-shrink-0 ${activeImage === img ? 'border-[#fbbf24]' : 'border-slate-200'}`}
                                    >
                            ...
                            <div className="flex items-center gap-3 text-sm text-slate-500 mb-4">
                                {product.rating && (
                                    <span className="flex items-center gap-1">
                                        <i className="fas fa-star text-amber-400"></i> {product.rating}
                                    </span>
                                )}
                                ...
                                <table className="w-full text-sm">
                                    <tbody>
                                        {product.specs.map((spec, i) => {
                                            // Hỗ trợ 2 dạng: {key, value} hoặc {name, value}
                ...
                {/* Mô tả chi tiết */}
                {product.description && (
                    <div className="bg-white p-6 lg:p-8 rounded-md border border-slate-200 mt-6">
                        <h2 className="text-sm font-bold text-slate-800 mb-3 uppercase tracking-wide">
                            Mô tả sản phẩm
                        </h2>
