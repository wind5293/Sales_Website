...
export default function Login({ onNavigate, onLoginSuccess }) {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center bg-[url('https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=1964')] bg-cover bg-center bg-no-repeat px-4 sm:px-6 py-10">
