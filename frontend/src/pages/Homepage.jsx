    ...
    return (
        <div className="bg-slate-50 min-height-screen font-sans">
            ...
            <main className="max-w-7xl mx-auto px-4 py-8 space-y-12">
                ...
                <section className="grid grid-columns-1 lg:grid-cols-3 gap-6">
                    {/* Banner chính lớn bên trái */}
                    <div className="lg:col-span-2 rounded-2xl relative overflow-hidden h-[460px] bg-slate-900 text-white flex items-center px-12 shadow-sm group">
                        <div className="absolute inset-0 z-0 bg-cover bg-center opacity-60 group-hover:scale-102 transition-transform duration-700" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1593642632823-8f785ba67e45?q=80&w=1200')" }}></div>
                        <div className="relative z-10 max-w-md">
                            <span className="bg-[#fbbf24] text-[#1e293b] font-bold text-xs px-3 py-1 rounded mb-4 inline-block uppercase tracking-wider">Ưu đãi tuần này</span>
                            <h1 className="text-4xl lg:text-5xl font-extrabold mb-4 leading-tight">Shop to get what <span className="text-[#fbbf24]">you love.</span></h1>
                            <p className="text-slate-300 text-sm mb-6">Trải nghiệm các dòng máy tính xách tay thế hệ mới mang lại hiệu năng đỉnh cao cho công việc.</p>
                            <a href="#shop" className="bg-[#fbbf24] hover:bg-[#f59e0b] text-[#1e293b] font-bold text-sm px-6 py-3 rounded-full inline-block shadow-lg transition-transform transform hover:-translate-y-0.5">MUA NGAY</a>
                        </div>
                    </div>

                    {/* Cặp Banner phụ bên phải */}
                    <div className="flex flex-col gap-6">
                        <div className="flex-1 rounded-2xl relative overflow-hidden p-6 text-white flex items-center bg-[#1e293b]">
                            <div className="absolute inset-0 bg-cover bg-center opacity-40" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=600')" }}></div>
                            <div className="relative z-10">
                                ...
                                <a href="#shop" className="text-xs font-bold border-b border-white pb-1 hover:text-[#fbbf24] hover:border-[#fbbf24]">Xem ngay</a>
                            </div>
                        </div>
                        <div className="flex-1 rounded-2xl relative overflow-hidden p-6 text-[#1e293b] flex items-center bg-[#fbbf24]/10 border border-[#fbbf24]/30">
                            <div className="absolute inset-0 bg-cover bg-center opacity-20" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?q=80&w=600')" }}></div>
                            <div className="relative z-10">
                ...
                <section className="bg-white border border-slate-200 rounded-2xl p-6 lg:p-8 flex flex-col md:flex-row items-center gap-8 shadow-sm">
                    {/* Cột chữ và Đồng hồ đếm ngược */}
                    <div className="flex-1 space-y-4">
                        <div className="text-red-500 font-bold uppercase tracking-wider text-sm flex items-center gap-2">
                            <span className="w-2 h-2 rounded-full bg-red-500 animate-pulse"></span> Ưu đãi giới hạn độc quyền
                        </div>
                        ...
                        <div className="flex gap-3 py-2">
                            <div className="bg-slate-100 rounded-lg p-3 text-center min-w-[65px]">
                        ...
                        <div className="flex items-baseline gap-3">
                            <span className="text-3xl font-extrabold text-red-500">$90.00</span>
                            <span className="text-base text-slate-400 line-through">$99.00</span>
                            <span className="text-xs bg-red-100 text-red-600 font-bold px-2 py-0.5 rounded">Tiết kiệm $9.00</span>
                        </div>
                    </div>

                    {/* Cột ảnh lớn của sản phẩm Flash Sale */}
                    <div className="w-full md:w-1/2 max-h-[300px] flex justify-center bg-slate-50 rounded-xl p-4 overflow-hidden">
                        <img
